...
class Kaniko(object):
    ...
    """
    Set this flag as --context to mount set workdir in build context.
    """
    context: Optional[str] = None

    """
    Set this flag as --sub-context to mount set workdir in build context.
    """
    ...
    """
    skip_unused_stages: Optional[str] = None
